...
echo $status = curl_get("https://simak.poliupg.ac.id/api/machine/get_tabel_konten/bri_mhs_aktif/thn_ajar/20201/kode_prodi/425/kelas/4B/jk/P");
// Mengencode data menjadi json
echo $jsonfile = json_encode($status, JSON_PRETTY_PRINT);
// Menyimpan data ke dalam anggota.json
echo file_put_contents('mahasiswa.json', $jsonfile);
